...
public interface SNMPRequestListener
{
    ...
    */
    ...
    public SNMPSequence processRequest(SNMPPDU requestPDU, String communityName, DatagramPacket inpacket)
        throws SNMPGetException, SNMPSetException;
    ...
    */
    ...
    public SNMPSequence processGetNextRequest(SNMPPDU requestPDU, String communityName, DatagramPacket inpacket)
        throws SNMPGetException;
