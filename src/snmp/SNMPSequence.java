    ...
    */
    ...
    private byte[] encodeVector()
    {
        ...
        for (int i = 0; i < numElements; ++i)
        {
            ...
            outBytes.write(nextBytes, 0, nextBytes.length);// keep add add add...d outbytes will increase..
        }
        ...
        throws SNMPBadValueException
    {
        ...
        {
            SNMPTLV nextTLV = SNMPBERCodec.extractNextTLV(enc, position);//get back pure byte array for each data/param.
            newVector.insertElementAt(SNMPBERCodec.extractEncoding(nextTLV), newVector.size());//convert back to reeal data here.
